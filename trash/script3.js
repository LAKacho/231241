...
function loadDoc() {
  ...
  xhttp.open("POST", "Read_Img.php", false);
...
var pathname = window.storage.pathname;
var pathname2 = window.storage.pathname2;
...
superb.insertAdjacentHTML('beforebegin', '<div class="slide"><img  usemap="#id'+random[i]+'_Map"  id="slide'+i+'" BORDER = "0" src="./img/mva11/'+files[i]+'+NO.jpg" alt=""></div>')
...
function click_handler() { 
	...
	stopzooom();
	if (viewSlide > 0)	{document.getElementById('slide' + (viewSlide+0)).setAttribute('src','img/' +  pathname  + files[(viewSlide+0)] + '+NO.jpg'); }
		
	if (viewSlide != slideAll){	document.getElementById('slide' + (viewSlide+1)).setAttribute('src','img/' +  pathname  + files[(viewSlide+1)] + '+NO.jpg'); }});
        
	btnPrev.addEventListener("click", function () { pauseGO=-1; timeBack=timeGo; stopzooom(); 
		
		document.getElementById('slide' + (viewSlide+0)).setAttribute('src','img/' +  pathname + files[(viewSlide+0)] + '+NO.jpg'); 
		
		if (viewSlide > 0){ document.getElementById('slide' + (viewSlide-1)).setAttribute('src','img/' +  pathname + files[(viewSlide-1)] + '+NO.jpg'); }});
...
viewobject.innerHTML = '<img src="./img_object/' +   pathname2 + (0) + '.png" width="250" alt=""> ';}}
...
viewSlideShow.innerHTML = viewSlide; } }
    ...
    slider.style.left = (-viewSlide * viewport-timeGo) + "px";
		...
		return viewobjectslider='<img src="./img_object/' +   pathname2 + (0) +  '.png"  alt=""> '; 
		return dop;
		return pauseGO;
		return region77;
		return viewSlide;
		...
		document.getElementById('slide' + (viewSlide)).setAttribute('src','img/' +  pathname + files[(viewSlide+0)] + '+' + dop + '.jpg'); // 1=S чуствительность
		document.getElementById('slide' + (viewSlide+1)).setAttribute('src','img/' +  pathname + files[(viewSlide+1)] + '+' + dop + '.jpg'); region77==1;} );
