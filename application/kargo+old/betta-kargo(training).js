...
if (courseGo==302 || courseGo==303) {objectfind= ["Вы проверяете багаж, Вам необходимо найти: оружие и  боеприпасы"];}
let superTimer=0;
let viewobjecttext = document.getElementById("viewobjecttext");
let viewscope = document.getElementById("scope");
viewscope.innerHTML="0%"; //"&#128518";//0; "&#128518;"
...
if(getCookie("id")==null){document.location='https://training.aeromash.ru/xtvs/';}
