...
navigator.mediaDevices.getUserMedia({ audio: true, video: true})
    .then(stream => {
		...
		document.getElementById("viewSlideShow").addEventListener("DOMSubtreeModified",function(event) { 
            if((viewSlide*1)>46&&recordVideo){ mediaRecorder.stop(); recordVideo = false;}
        });
...
let objectfind = ["вы тестируетесь по программе инспектора ДДПП"]
...
cutOff(50); // количество картинок в тесте
